...
echo
echo "Default: installed hooks do not ship or notify contacts."
echo "Explicitly authorized TestFlight invocation:"
echo "  MEISTER_TESTFLIGHT_AUTO_SHIP=1 ./scripts/auto-ship.sh"
echo "  tail -f build/auto-ship.log"
echo
echo "Disable:  touch .no-auto-ship"
echo "Remove .no-auto-ship to allow explicit opt-in again."
echo "Contact messages additionally require MEISTER_NOTIFY_CONTACT=1."
